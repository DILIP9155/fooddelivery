...
const Additems = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const result = await axios.post(`${serverUrl}/api/item/add-food`, formData, {
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-lg bg-white shadow-xl rounded-2xl p-6 relative">
        ...
        <div className="flex flex-col items-center gap-3 mb-8 mt-6">
          ...
          <p className="text-sm text-gray-500">Fill in the details to add a new item to your shop</p>
        </div>
