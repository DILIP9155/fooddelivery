  ...
  return (
    ...
    >
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md p-8 border border-gray-200">
        {/* Title */}
        <h1
          className="text-3xl font-extrabold mb-2 text-center animate-pulse"
        ...
        <div className="mt-2 text-sm text-blue-600 cursor-pointer text-right hover:text-blue-800 hover:underline">
          <button
        ...
        {/* Submit button */}
        <button
          className="w-full py-3 rounded-lg font-semibold transition duration-200 cursor-pointer"
