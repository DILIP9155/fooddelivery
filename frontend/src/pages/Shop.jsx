...
function Shop() {
  ...
  const handleShop = async (req, res) => {
    try {
      ...
      console.log("Shop items", result.data);
  ...
  return (
    <div className='min-h-screen bg-gray-50'>
      ...
      {shop && <div className='relative w-full h-64 md:h-80 lg:h-96'>
        <img src={shop.image} alt={shop.name} className='w-full h-full object-cover brightness-75'/>
      ...
      <div className='max-w-7xl mx-auto px-6 py-10'>
        ...
        ):<p className='text-center text-gray-500 text-lg'>No Items Availaible</p>}
